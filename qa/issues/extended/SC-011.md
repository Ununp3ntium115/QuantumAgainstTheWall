...
- [ ] Test script created in `tests/security/SC-011.rs`
- [ ] Test passes locally
...
cargo test SC-011 --release

# Or run with verification script
./tests/security/verify_SC-011.sh
