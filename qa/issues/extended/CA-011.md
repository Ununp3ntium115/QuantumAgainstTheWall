---
id: CA-011
title: "Cryptanalytic Security Test 011"
severity: MEDIUM
...
# Cryptanalytic Security Test 011
...
- [ ] Test script created in `tests/security/CA-011.rs`
- [ ] Test passes locally
...
cargo test CA-011 --release

# Or run with verification script
./tests/security/verify_CA-011.sh
