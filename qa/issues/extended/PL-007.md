---
id: PL-007
title: "Protocol Attack Test 007"
severity: HIGH
...
- [ ] Test script created in `tests/security/PL-007.rs`
- [ ] Test passes locally
...
cargo test PL-007 --release

# Or run with verification script
./tests/security/verify_PL-007.sh
