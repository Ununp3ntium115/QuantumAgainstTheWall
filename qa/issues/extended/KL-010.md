...
- [ ] Test script created in `tests/security/KL-010.rs`
- [ ] Test passes locally
...
cargo test KL-010 --release

# Or run with verification script
./tests/security/verify_KL-010.sh
