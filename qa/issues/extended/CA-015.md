---
id: CA-015
title: "Cryptanalytic Security Test 015"
severity: MEDIUM
...
# Cryptanalytic Security Test 015
...
- [ ] Test script created in `tests/security/CA-015.rs`
- [ ] Test passes locally
...
cargo test CA-015 --release

# Or run with verification script
./tests/security/verify_CA-015.sh
