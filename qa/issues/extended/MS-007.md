...
- [ ] Test script created in `tests/security/MS-007.rs`
- [ ] Test passes locally
...
cargo test MS-007 --release

# Or run with verification script
./tests/security/verify_MS-007.sh
