...
- [ ] Test script created in `tests/security/SC-018.rs`
- [ ] Test passes locally
...
cargo test SC-018 --release

# Or run with verification script
./tests/security/verify_SC-018.sh
