---
id: OP-005
title: "Operational Security Test 005"
severity: MEDIUM
...
- [ ] Test script created in `tests/security/OP-005.rs`
- [ ] Test passes locally
...
cargo test OP-005 --release

# Or run with verification script
./tests/security/verify_OP-005.sh
