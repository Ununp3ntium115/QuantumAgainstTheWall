...
- [ ] Test script created in `tests/security/MS-010.rs`
- [ ] Test passes locally
...
cargo test MS-010 --release

# Or run with verification script
./tests/security/verify_MS-010.sh
