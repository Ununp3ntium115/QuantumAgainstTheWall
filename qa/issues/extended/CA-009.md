---
id: CA-009
title: "Cryptanalytic Security Test 009"
severity: MEDIUM
...
# Cryptanalytic Security Test 009
...
- [ ] Test script created in `tests/security/CA-009.rs`
- [ ] Test passes locally
...
cargo test CA-009 --release

# Or run with verification script
./tests/security/verify_CA-009.sh
