---
id: OP-004
title: "Operational Security Test 004"
severity: MEDIUM
...
- [ ] Test script created in `tests/security/OP-004.rs`
- [ ] Test passes locally
...
cargo test OP-004 --release

# Or run with verification script
./tests/security/verify_OP-004.sh
