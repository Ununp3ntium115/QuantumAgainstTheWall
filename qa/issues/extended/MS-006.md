...
- [ ] Test script created in `tests/security/MS-006.rs`
- [ ] Test passes locally
...
cargo test MS-006 --release

# Or run with verification script
./tests/security/verify_MS-006.sh
