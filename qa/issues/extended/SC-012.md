...
- [ ] Test script created in `tests/security/SC-012.rs`
- [ ] Test passes locally
...
cargo test SC-012 --release

# Or run with verification script
./tests/security/verify_SC-012.sh
