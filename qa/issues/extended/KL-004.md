...
- [ ] Test script created in `tests/security/KL-004.rs`
- [ ] Test passes locally
...
cargo test KL-004 --release

# Or run with verification script
./tests/security/verify_KL-004.sh
