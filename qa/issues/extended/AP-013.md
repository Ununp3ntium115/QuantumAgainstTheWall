---
id: AP-013
title: "API Misuse Prevention Test 013"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 013
...
- [ ] Test script created in `tests/security/AP-013.rs`
- [ ] Test passes locally
...
cargo test AP-013 --release

# Or run with verification script
./tests/security/verify_AP-013.sh
