...
- [ ] Test script created in `tests/security/MS-008.rs`
- [ ] Test passes locally
...
cargo test MS-008 --release

# Or run with verification script
./tests/security/verify_MS-008.sh
