---
id: RQ-008
title: "Randomness Quality Test 008"
severity: HIGH
category: randomness
...
- [ ] Test script created in `tests/security/RQ-008.rs`
- [ ] Test passes locally
...
cargo test RQ-008 --release

# Or run with verification script
./tests/security/verify_RQ-008.sh
