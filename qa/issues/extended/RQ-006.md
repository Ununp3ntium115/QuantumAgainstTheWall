---
id: RQ-006
title: "Randomness Quality Test 006"
severity: HIGH
category: randomness
...
- [ ] Test script created in `tests/security/RQ-006.rs`
- [ ] Test passes locally
...
cargo test RQ-006 --release

# Or run with verification script
./tests/security/verify_RQ-006.sh
