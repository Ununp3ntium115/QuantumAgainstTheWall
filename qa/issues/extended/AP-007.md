---
id: AP-007
title: "API Misuse Prevention Test 007"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 007
...
- [ ] Test script created in `tests/security/AP-007.rs`
- [ ] Test passes locally
...
cargo test AP-007 --release

# Or run with verification script
./tests/security/verify_AP-007.sh
