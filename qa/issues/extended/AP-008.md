---
id: AP-008
title: "API Misuse Prevention Test 008"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 008
...
- [ ] Test script created in `tests/security/AP-008.rs`
- [ ] Test passes locally
...
cargo test AP-008 --release

# Or run with verification script
./tests/security/verify_AP-008.sh
