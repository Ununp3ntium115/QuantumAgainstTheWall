---
id: AP-005
title: "API Misuse Prevention Test 005"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 005
...
- [ ] Test script created in `tests/security/AP-005.rs`
- [ ] Test passes locally
...
cargo test AP-005 --release

# Or run with verification script
./tests/security/verify_AP-005.sh
