---
id: AP-010
title: "API Misuse Prevention Test 010"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 010
...
- [ ] Test script created in `tests/security/AP-010.rs`
- [ ] Test passes locally
...
cargo test AP-010 --release

# Or run with verification script
./tests/security/verify_AP-010.sh
