...
- [ ] Test script created in `tests/security/SC-020.rs`
- [ ] Test passes locally
...
cargo test SC-020 --release

# Or run with verification script
./tests/security/verify_SC-020.sh
