---
id: AP-004
title: "API Misuse Prevention Test 004"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 004
...
- [ ] Test script created in `tests/security/AP-004.rs`
- [ ] Test passes locally
...
cargo test AP-004 --release

# Or run with verification script
./tests/security/verify_AP-004.sh
