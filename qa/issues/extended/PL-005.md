---
id: PL-005
title: "Protocol Attack Test 005"
severity: HIGH
...
- [ ] Test script created in `tests/security/PL-005.rs`
- [ ] Test passes locally
...
cargo test PL-005 --release

# Or run with verification script
./tests/security/verify_PL-005.sh
