---
id: PL-008
title: "Protocol Attack Test 008"
severity: HIGH
...
- [ ] Test script created in `tests/security/PL-008.rs`
- [ ] Test passes locally
...
cargo test PL-008 --release

# Or run with verification script
./tests/security/verify_PL-008.sh
