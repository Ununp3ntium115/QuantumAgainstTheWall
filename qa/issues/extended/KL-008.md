...
- [ ] Test script created in `tests/security/KL-008.rs`
- [ ] Test passes locally
...
cargo test KL-008 --release

# Or run with verification script
./tests/security/verify_KL-008.sh
