...
- [ ] Test script created in `tests/security/KL-009.rs`
- [ ] Test passes locally
...
cargo test KL-009 --release

# Or run with verification script
./tests/security/verify_KL-009.sh
