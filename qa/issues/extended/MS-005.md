...
- [ ] Test script created in `tests/security/MS-005.rs`
- [ ] Test passes locally
...
cargo test MS-005 --release

# Or run with verification script
./tests/security/verify_MS-005.sh
