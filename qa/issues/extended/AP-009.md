---
id: AP-009
title: "API Misuse Prevention Test 009"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 009
...
- [ ] Test script created in `tests/security/AP-009.rs`
- [ ] Test passes locally
...
cargo test AP-009 --release

# Or run with verification script
./tests/security/verify_AP-009.sh
