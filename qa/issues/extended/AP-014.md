---
id: AP-014
title: "API Misuse Prevention Test 014"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 014
...
- [ ] Test script created in `tests/security/AP-014.rs`
- [ ] Test passes locally
...
cargo test AP-014 --release

# Or run with verification script
./tests/security/verify_AP-014.sh
