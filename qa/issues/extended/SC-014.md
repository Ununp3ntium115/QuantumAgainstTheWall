...
- [ ] Test script created in `tests/security/SC-014.rs`
- [ ] Test passes locally
...
cargo test SC-014 --release

# Or run with verification script
./tests/security/verify_SC-014.sh
