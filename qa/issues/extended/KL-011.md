...
- [ ] Test script created in `tests/security/KL-011.rs`
- [ ] Test passes locally
...
cargo test KL-011 --release

# Or run with verification script
./tests/security/verify_KL-011.sh
