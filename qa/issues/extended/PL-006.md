---
id: PL-006
title: "Protocol Attack Test 006"
severity: HIGH
...
- [ ] Test script created in `tests/security/PL-006.rs`
- [ ] Test passes locally
...
cargo test PL-006 --release

# Or run with verification script
./tests/security/verify_PL-006.sh
