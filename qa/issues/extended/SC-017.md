...
- [ ] Test script created in `tests/security/SC-017.rs`
- [ ] Test passes locally
...
cargo test SC-017 --release

# Or run with verification script
./tests/security/verify_SC-017.sh
