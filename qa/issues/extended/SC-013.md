...
- [ ] Test script created in `tests/security/SC-013.rs`
- [ ] Test passes locally
...
cargo test SC-013 --release

# Or run with verification script
./tests/security/verify_SC-013.sh
