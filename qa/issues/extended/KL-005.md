...
- [ ] Test script created in `tests/security/KL-005.rs`
- [ ] Test passes locally
...
cargo test KL-005 --release

# Or run with verification script
./tests/security/verify_KL-005.sh
