---
id: OP-006
title: "Operational Security Test 006"
severity: MEDIUM
...
- [ ] Test script created in `tests/security/OP-006.rs`
- [ ] Test passes locally
...
cargo test OP-006 --release

# Or run with verification script
./tests/security/verify_OP-006.sh
