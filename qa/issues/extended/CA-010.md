---
id: CA-010
title: "Cryptanalytic Security Test 010"
severity: MEDIUM
...
# Cryptanalytic Security Test 010
...
- [ ] Test script created in `tests/security/CA-010.rs`
- [ ] Test passes locally
...
cargo test CA-010 --release

# Or run with verification script
./tests/security/verify_CA-010.sh
