---
id: AP-015
title: "API Misuse Prevention Test 015"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 015
...
- [ ] Test script created in `tests/security/AP-015.rs`
- [ ] Test passes locally
...
cargo test AP-015 --release

# Or run with verification script
./tests/security/verify_AP-015.sh
