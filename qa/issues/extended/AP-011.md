---
id: AP-011
title: "API Misuse Prevention Test 011"
severity: MEDIUM
category: api-misuse
...
# API Misuse Prevention Test 011
...
- [ ] Test script created in `tests/security/AP-011.rs`
- [ ] Test passes locally
...
cargo test AP-011 --release

# Or run with verification script
./tests/security/verify_AP-011.sh
