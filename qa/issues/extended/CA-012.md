---
id: CA-012
title: "Cryptanalytic Security Test 012"
severity: MEDIUM
...
# Cryptanalytic Security Test 012
...
- [ ] Test script created in `tests/security/CA-012.rs`
- [ ] Test passes locally
...
cargo test CA-012 --release

# Or run with verification script
./tests/security/verify_CA-012.sh
