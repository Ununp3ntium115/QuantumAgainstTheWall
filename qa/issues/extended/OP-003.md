---
id: OP-003
title: "Operational Security Test 003"
severity: MEDIUM
...
- [ ] Test script created in `tests/security/OP-003.rs`
- [ ] Test passes locally
...
cargo test OP-003 --release

# Or run with verification script
./tests/security/verify_OP-003.sh
